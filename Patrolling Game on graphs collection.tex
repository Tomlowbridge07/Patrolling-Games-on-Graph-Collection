...
By the attacker using the symmetric dual star attack and the patroller using an random oscillation patrol (in the usual fashion), we acheive the value when $m \geq 2n+1$ of
$$ V=\frac{m}{4n+2} $$
\end{lemma}
